// src/components/compUserInfoCardFromPainting.tsx
...
export function СompUserInfoCardFromPainting({ 
  user, 
  loading = false 
}: { 
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 group">
                ...
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 mb-2">
                  {copied ? (
                    ...
                    <Copy className="w-5 h-5 text-gray-400 hover:text-blue-500 cursor-pointer" onClick={copyUsername} />
                  )}
                </div>
              </div>
