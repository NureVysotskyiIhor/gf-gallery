      ...
      <div className="relative z-10 max-w-6xl mx-auto p-4 sm:p-6 space-y-8">
        ...
        <div className="text-center pt-6 pb-4">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            {user.role_id === 1
              ? t('manageProfileAndFavorites')
              : t('manageProfileAndGallery')
            }
          </p>
        </div>

        {/* Section with components */}
        <section className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 shadow-lg space-y-8 animate-fade-in">
          {/* User Info */}
          <div className="p-6">
